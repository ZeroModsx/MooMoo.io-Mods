...
// @match        *://dev.moomoo.io/*
// @grant        none
// @icon         https://cdn.discordapp.com/attachments/901837657481564203/906309578797510706/perfil.png
// ==/UserScript==
...
function handleMessage(m){
    ...
    if(packet == "9" && data[1] == "kills"){
        doNewSend(["ch", ["Ban +1 kill free ty"]]);
    }
    if(nearestEnemy) {
        if(nearestEnemy[5] == 7) {
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 38 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(autoreplace==false) {
            chat("Ban AutoReplace: ON");
            autoreplace=true;
        }else {
            chat("Ban AutoReplace: OFF");
            autoreplace=false;
        }
    }
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports.nameY = 34,
        e.exports.skinColors = ["#ff0000", "#00b7ff", "#00ff22", "#fffb00", "#0011ff", "#00ffff", "#000000", "#d800ff", "#00194f", "#4dff00"],
            ...
            this.update = function(e) {
                if (this.active) {
                    ...
                    this.hitWait <= 0)) {
                        ...
                        for (var I, E = i.getGridArrays(this.x, this.y, this.hitRange), M = 0; M < E.length; ++M)
                            for (x = 0; x < E[M].length; ++x)
                                (I = E[M][x]).health && a.getDistance(this.x, this.y, I.x, I.y) < I.scale + this.hitRange && (I.changeHealth(5 * -this.dmg) && ("bait" === I.name && (this.waitCount = 1,
                                this.chargeBait = this.baitTarget = null),
                                i.disableObj(I)),
                                i.hitObj(I, a.getDirection(this.x, this.y, I.x, I.y)));
                        for (x = 0; x < r.length; ++x)
                    ...
                    if (s || T || this.chargeBait) {
                        let e, n, s;
                        if (this.baitTarget)
                            (e = this.baitTarget) && e.health > 0 && "bait" === e.name && (n = a.getDistance(this.x, this.y, e.x, e.y),
                            this.hitRange ? !this.hitWait && n <= this.hitRange + e.scale && (T ? (s = a.getDirection(e.x, e.y, this.x, this.y),
                            e.changeHealth(-this.dmg * (1 + o.MAX_ATTACK * t.DARKNESS)) && (i.disableObj(e),
                            this.waitCount = 1,
                            this.chargeBait = this.baitTarget = null),
